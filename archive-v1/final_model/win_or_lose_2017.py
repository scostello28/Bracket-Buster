...
if __name__ == '__main__':
    ...
    finalgames2017 = pd.read_pickle('final_model_data/season2017_final_stats.pkl')
    # finalgames2017_noclust = pd.read_pickle('final_model_data/season2017_final_stats_no_clust.pkl')
    ...
    gb_model_no_clust = 'fit_models/gb_fit_model_2017_no_clust.pkl'
    ...
    print('\n')
    print('With Clusters')
    matchup = merge(finalgames2017, team1, team2, cluster=True)
    matchup_reversed = merge(finalgames2017, team2, team1, cluster=True)
    game_predict(model, matchup, matchup_reversed)
    print('\n')
    print('No Clusters')
    no_clust_matchup = merge(finalgames2017, team1, team2, cluster=False)
    no_clust_matchup_reversed = merge(finalgames2017, team2, team1, cluster=False)
