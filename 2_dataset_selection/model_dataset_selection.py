...
if __name__ == '__main__':
    ...
    gamelog_roll2 = pd.read_pickle('data/gamelogs_2.pkl')
    gamelog_roll3 = pd.read_pickle('data/gamelogs_3.pkl')
    gamelog_roll4 = pd.read_pickle('data/gamelogs_4.pkl')
    gamelog_roll5 = pd.read_pickle('data/gamelogs_5.pkl')
    gamelog_roll6 = pd.read_pickle('data/gamelogs_6.pkl')
    gamelog_roll7 = pd.read_pickle('data/gamelogs_7.pkl')

    '''
    Test datasets with various models.
    '''
    datasets = [gamelog_roll2, gamelog_roll3, gamelog_roll4,
    gamelog_roll5, gamelog_roll6, gamelog_roll7]
