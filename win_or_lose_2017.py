...
if __name__ == '__main__':
    ...
    finalgames2017_data = pd.read_pickle('3_final_model_data/season2017_final_stats.pkl')
    finalgames2017 = pre_matchup_feature_selection(finalgames2017_data, 'gamelogs')
    finalgames2017_exp_tcf = pre_matchup_feature_selection(finalgames2017_data, 'exp_tcf')

    # lr_model = 'fit_models/lr_fit_model.pkl'
    # rf_model = 'fit_models/rf_fit_model.pkl'
    gb_model = 'fit_models/gb_fit_model_2017.pkl'
    ...
    gb_model_exp_tcf = 'fit_models/gb_fit_model_2017_exp_tcf.pkl'
    ...
    print('\n')
    print('w/o TCF')
    matchup = merge(finalgames2017, team1, team2, tcf=False)
    matchup_reversed = merge(finalgames2017, team2, team1, tcf=False)
    game_predict(model, matchup, matchup_reversed)
    print('\n')
    print('w/ TCF')
    matchup_exp_tcf = merge(finalgames2017_exp_tcf, team1, team2, tcf=True)
    matchup_exp_tcf_reversed = merge(finalgames2017_exp_tcf, team2, team1, tcf=True)
