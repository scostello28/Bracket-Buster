...
import theano
from filters import games_up_to_2018_tourney_filter, tourney2018_filter, games_up_to_2017_tourney_filter
...
#     '''
#
#     games_filter = games_up_to_2018_tourney_filter(df)
#
#     if clusters and odds:
#         Xy = games_filter[['W', 'Wp', 'ppg', 'pApg', 'FGp',
...
def gb_model(X, y):
    ...
    filename = "fit_models/gb_fit_model_2017_no_clust.pkl"
    with open(filename, 'wb') as f:
        # Write the model to a file.
...
if __name__ == '__main__':
    ...
    data = pd.read_pickle('3_final_model_data/gamelog_exp_clust.pkl')
